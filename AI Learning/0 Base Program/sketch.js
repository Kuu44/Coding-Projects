...
var gridWidth, gridHeight, gridRadius;
...
function setup() {
    ...
    gridRadius = (gridHeight + gridWidth) / 4;
...
function DrawGrid() {
    ...
    //    closedSet[i].Show(color(255, 204, 102));
...
function DrawPath(current){
    ...
    noFill();
    stroke(90, 200, 255);
    strokeWeight(gridRadius*2);
    beginShape();
    for (var i = 0; i < path.length; i++) {
        vertex(path[i].x * gridWidth + gridRadius,
            path[i].y * gridHeight + gridRadius);
    }
    endShape();
}
