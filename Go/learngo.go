...
func learnFlowControl() {
	...
	default:
	 ...
	 //Hence s[i] prints the decimal value of the byte held by the
	 //character. But to see individual characters, you can use %c
	 //format string in Printf statement. You can also use %v format
	 //string to see the byte value, %x to see hex value  and
