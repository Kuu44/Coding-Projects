...
public:
    ...
    void playersUpdate()
    {
        B.move(Keyboard::Left, Keyboard::Right, Keyboard::Up, Keyboard::Down, Keyboard::M, &A, &football);
        A.move(Keyboard::A,    Keyboard::D,     Keyboard::W,  Keyboard::S,    Keyboard::C, &B, &football);
    }
